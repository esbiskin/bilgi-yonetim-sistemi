...
<body style="background-color:#0b1e60ff">
    ...
    <h2>İŞLEM YAPILACAK T.C. KİMLİK NO</h2>
    
    <div id="form">
        <form method="post" action="islem.php">

            
            <input type="text" placeholder="T.C. Kimlik Numarasını Giriniz" name="tc_kimlik_no"  maxlength="11" title="11 Haneli T.C. Kimlik Numarasını Giriniz."> <br/><br>

            <button class="btn" id="sorgulabuton" type="submit"  name="sorgulabuton" style="width:130px;background-color: rgb(1, 14, 61);color:white;margin:2px 0 5% 0;">Sorgula</button>
        </form>
        <button class="btn " onclick="window.location.href='secenek.php';" type="submit" style="width:130px;margin:-8% 0 0 0;background-color: rgb(1, 14, 61);color:white;"><span>Geri </span></button>
      </div>
