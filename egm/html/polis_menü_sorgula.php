...
<body style="background-color:#0b1e60ff">
    ...
    <p>Yapmak İstediğiniz Sorgulamayı Seçiniz</p>

    <button id="sabikakaydi" type="submit" onclick="location.href='polis_sorgu_sabika_kaydi.php?tc_kimlik_no=<?php echo $kimlikcek['tc_kimlik_no']?>';">Sabıka Kaydı</button>

    <button id="trafikcezalari" type="submit" onclick="location.href='polis_sorgu_trafik_cezalari.php?tc_kimlik_no=<?php echo $kimlikcek['tc_kimlik_no']?>';">Trafik Cezaları</button>

    <button id="ehliyetdurumu" type="submit" onclick="location.href='polis_sorgu_ehliyet_durumu.php?tc_kimlik_no=<?php echo $kimlikcek['tc_kimlik_no']?>';">Ehliyet Durumu</button>

    <button id="kimlikbilgileri" type="submit" onclick="location.href='polis_sorgu_kimlik_bilgileri.php?tc_kimlik_no=<?php echo $kimlikcek['tc_kimlik_no']?>';">Kimlik Bilgileri</button>

    <div id="geri">
        <button class="geri" style="vertical-align:middle" onclick="location.href='logout.php';"><span>Çıkış Yap</span></button>
