          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2 style="text-align:center;">Kimlik Bilgileri Kayıt Ekleme <small>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="islem.php" method="POST">
                      ...
                      <div class="form-group">
                        ...
                        <div id="geri">
                        <button class="geri" style="vertical-align:middle;" name="kimlikekle" ><span> Kayıt Ekle </span></button>
                    ...
                    <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3" align="right">
                        <div id="geri">
                        <a href="polis_islem_kimlik_bilgileri.php"><button class="geri" style="vertical-align:middle"><span>Geri</span></button></a> 
