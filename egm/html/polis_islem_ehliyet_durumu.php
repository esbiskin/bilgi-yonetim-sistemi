...
<body style="background-color:#0b1e60ff">
  ...
  while($ehliyetcek=$ehliyetsor->fetch(PDO::FETCH_ASSOC)) {?>
        <tr>
          ...
          <td><a href="islem.php?ehliyet_id=<?php echo $ehliyetcek['ehliyet_id']; ?>&ehliyetsil=ok"><svg class="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="cursor:pointer;text_decoration:none;color:White;">
  ...
  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
    ...
    <a href="ehliyet_ekle.php">   <button class="geri" style="vertical-align:middle;"  ><span>Kayıt Ekle </span></button></a>
