...
$cezasor=$db->prepare("SELECT * FROM trafik_cezalari ");
$cezasor->execute();
...
<body style="background-color:#0b1e60ff">
    ...
    <tr>
          ...
          <th>Alınan Ceza</th>
          <th>Plaka</th>
          <th>Yer/Ceza Sebebi</th>
<th></th>

        </tr>
    <?php
 while($cezacek=$cezasor->fetch(PDO::FETCH_ASSOC)) {?>
        <tr>
          <td><?php echo $cezacek['tc_kimlik_no'] ?></td>
          <td><?php echo $cezacek['alinan_ceza'] ?></td>
          <td><?php echo $cezacek['plaka'] ?></td>
          <td><?php echo $cezacek['yer_ceza_sebebi'] ?></td>
          <td><a href="islem.php?trafik_id=<?php echo $cezacek['trafik_id']; ?>&cezasil=ok"><svg class="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" style="cursor:pointer;text_decoration:none;color:White;">
  ...
  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
    ...
    <a href="ceza_ekle.php">    <button class="geri" style="vertical-align:middle;"><span>Kayıt Ekle </span></button></a>
